...
@Autonomous(name="bingChillingMinecraft", group="auto")
public class bingChillingMinecraftAuto extends LinearOpMode {
        ...
        if (!isStopRequested()){
            switch (level) {
                case 1:
                    ...
                    sleep(250);
                    linearMovement(19, 1.5, 0.0004, 0.00007, 0.000068);
                    sleep(250);
